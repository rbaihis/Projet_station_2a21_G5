#ifndef MAINWINDOWSEIF_H
#define MAINWINDOWSEIF_H
...
QT_BEGIN_NAMESPACE
namespace Ui { class MainWindowseif; }
QT_END_NAMESPACE

class MainWindowseif : public QMainWindow
{
    Q_OBJECT
    ...
    int firsttimeRowcount0;
    QString firstimeNoAdminShouldExist;
    bool AdminExistance;


public:
    MainWindowseif(QWidget *parent = nullptr);
    ~MainWindowseif();
    //----------------------------------
...
private slots:
   ...
   // void on_groupBox_chercher_clicked();
    ...
    void on_pushButton_FullAccess_clicked();

private:
    Ui::MainWindowseif *ui;
    //login
    QString currentuser;
    //
    //email
