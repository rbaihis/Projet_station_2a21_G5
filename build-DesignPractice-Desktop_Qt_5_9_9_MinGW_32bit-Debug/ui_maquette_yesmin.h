/********************************************************************************
** Form generated from reading UI file 'maquette_yesmin.ui'
**
...
#ifndef UI_MAQUETTE_YESMIN_H
#define UI_MAQUETTE_YESMIN_H
...
public:
    ...
    void setupUi(QDialog *maquette_yesmin)
    {
        if (maquette_yesmin->objectName().isEmpty())
            maquette_yesmin->setObjectName(QStringLiteral("maquette_yesmin"));
        maquette_yesmin->resize(1138, 498);
        Trier = new QTabWidget(maquette_yesmin);
        Trier->setObjectName(QStringLiteral("Trier"));
        Trier->setGeometry(QRect(10, 0, 1101, 471));
        tab = new QWidget();
...
"color: rgb(84, 105, 127);"));
        ...
        retranslateUi(maquette_yesmin);

        Trier->setCurrentIndex(5);


        QMetaObject::connectSlotsByName(maquette_yesmin);
    } // setupUi

    void retranslateUi(QDialog *maquette_yesmin)
    {
        maquette_yesmin->setWindowTitle(QApplication::translate("maquette_yesmin", "Dialog", Q_NULLPTR));
        groupBox->setTitle(QApplication::translate("maquette_yesmin", "Ajouter", Q_NULLPTR));
        label->setText(QApplication::translate("maquette_yesmin", "Nom ", Q_NULLPTR));
        label_2->setText(QApplication::translate("maquette_yesmin", "Pr\303\251nom", Q_NULLPTR));
        label_3->setText(QApplication::translate("maquette_yesmin", "Cin", Q_NULLPTR));
        label_4->setText(QApplication::translate("maquette_yesmin", "Num T\303\251l\303\250phone", Q_NULLPTR));
        label_5->setText(QString());
        label_6->setText(QApplication::translate("maquette_yesmin", "Gestion Des Reclamations", Q_NULLPTR));
        label_7->setText(QString());
        label_11->setText(QString());
        label_8->setText(QApplication::translate("maquette_yesmin", "Num Bus ", Q_NULLPTR));
        label_9->setText(QApplication::translate("maquette_yesmin", "Num Station", Q_NULLPTR));
        label_10->setText(QApplication::translate("maquette_yesmin", "Type de Reclamation :", Q_NULLPTR));
        label_12->setText(QApplication::translate("maquette_yesmin", "1) Resources Humaine", Q_NULLPTR));
        label_13->setText(QApplication::translate("maquette_yesmin", "2) Ticket", Q_NULLPTR));
        label_14->setText(QApplication::translate("maquette_yesmin", "3) Bus", Q_NULLPTR));
        label_15->setText(QApplication::translate("maquette_yesmin", "4) Station", Q_NULLPTR));
        label_16->setText(QApplication::translate("maquette_yesmin", "5) Autres", Q_NULLPTR));
        pb_ajouter->setText(QApplication::translate("maquette_yesmin", "Ajouter", Q_NULLPTR));
        Trier->setTabText(Trier->indexOf(tab), QApplication::translate("maquette_yesmin", "Ajouter Recalamation", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("maquette_yesmin", "Afficher", Q_NULLPTR));
        pb_arduino->setText(QApplication::translate("maquette_yesmin", "Arduino", Q_NULLPTR));
        Trier->setTabText(Trier->indexOf(tab2), QApplication::translate("maquette_yesmin", "Afficher Reclamation", Q_NULLPTR));
        label_17->setText(QApplication::translate("maquette_yesmin", "Cin", Q_NULLPTR));
        pb_supprimer->setText(QApplication::translate("maquette_yesmin", "Supprimer", Q_NULLPTR));
        label_31->setText(QApplication::translate("maquette_yesmin", "Cin", Q_NULLPTR));
        Trier->setTabText(Trier->indexOf(tab_2), QApplication::translate("maquette_yesmin", "Supprimer Reclamation", Q_NULLPTR));
        pushButton_modifier_2->setTitle(QApplication::translate("maquette_yesmin", "Modifier", Q_NULLPTR));
        label_18->setText(QApplication::translate("maquette_yesmin", "Nom", Q_NULLPTR));
        label_20->setText(QApplication::translate("maquette_yesmin", "Num Bus", Q_NULLPTR));
        label_21->setText(QApplication::translate("maquette_yesmin", "Pr\303\251nom", Q_NULLPTR));
        label_22->setText(QApplication::translate("maquette_yesmin", "Num Telephone", Q_NULLPTR));
        label_23->setText(QApplication::translate("maquette_yesmin", "Num Station", Q_NULLPTR));
        label_24->setText(QApplication::translate("maquette_yesmin", "Type De  Reclamation : ", Q_NULLPTR));
        label_19->setText(QApplication::translate("maquette_yesmin", "Cin", Q_NULLPTR));
        pushButton_modifier->setText(QApplication::translate("maquette_yesmin", "Modifier", Q_NULLPTR));
        label_25->setText(QApplication::translate("maquette_yesmin", "Gestion Des Reclamations", Q_NULLPTR));
        label_26->setText(QApplication::translate("maquette_yesmin", "1) Resources Humaines", Q_NULLPTR));
        label_27->setText(QApplication::translate("maquette_yesmin", "2)Ticket", Q_NULLPTR));
        label_28->setText(QApplication::translate("maquette_yesmin", "3)Bus", Q_NULLPTR));
        label_29->setText(QApplication::translate("maquette_yesmin", "4)Station", Q_NULLPTR));
        label_30->setText(QApplication::translate("maquette_yesmin", "5)Autres", Q_NULLPTR));
        Trier->setTabText(Trier->indexOf(tab3), QApplication::translate("maquette_yesmin", "Modifier Reclamation", Q_NULLPTR));
        Generer_PDF->setText(QApplication::translate("maquette_yesmin", "Generer", Q_NULLPTR));
        label_32->setText(QApplication::translate("maquette_yesmin", "Cin", Q_NULLPTR));
        Trier->setTabText(Trier->indexOf(tab_3), QApplication::translate("maquette_yesmin", "Generer PDF Reclamation", Q_NULLPTR));
        pb_recherche->setText(QApplication::translate("maquette_yesmin", "Chercher", Q_NULLPTR));
        label_33->setText(QApplication::translate("maquette_yesmin", "Rechercher :", Q_NULLPTR));
        label_34->setText(QApplication::translate("maquette_yesmin", "Trier :", Q_NULLPTR));
        radioButton_trier_reclamation_AZ->setText(QApplication::translate("maquette_yesmin", "Ascendant", Q_NULLPTR));
        radioButton_trier_reclamation_ZA->setText(QApplication::translate("maquette_yesmin", "Desendant", Q_NULLPTR));
        pb_tri->setText(QApplication::translate("maquette_yesmin", "Trier", Q_NULLPTR));
        comboBox_tri_reclamation->clear();
        comboBox_tri_reclamation->insertItems(0, QStringList()
         << QApplication::translate("maquette_yesmin", "Cin", Q_NULLPTR)
         << QApplication::translate("maquette_yesmin", "Type_Reclamation ", Q_NULLPTR)
         << QApplication::translate("maquette_yesmin", "Num_Telephone", Q_NULLPTR)
        );
        pb_stat->setText(QApplication::translate("maquette_yesmin", "Statistique", Q_NULLPTR));
        Trier->setTabText(Trier->indexOf(tab_4), QApplication::translate("maquette_yesmin", "Recherche et Tri", Q_NULLPTR));
        label_35->setText(QApplication::translate("maquette_yesmin", "Resources Humaines", Q_NULLPTR));
        label_36->setText(QApplication::translate("maquette_yesmin", "ticket", Q_NULLPTR));
        label_37->setText(QApplication::translate("maquette_yesmin", "Station", Q_NULLPTR));
        label_38->setText(QApplication::translate("maquette_yesmin", "Bus", Q_NULLPTR));
        Trier->setTabText(Trier->indexOf(tab_5), QApplication::translate("maquette_yesmin", "Affecter Reclamation", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class maquette_yesmin: public Ui_maquette_yesmin {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MAQUETTE_YESMIN_H
