...
void MainWindow::on_lineEdit_id_search_modifier_field_textEdited()
{
    QSqlQuery myquery;
...
bool MainWindow::checking_user_log_in_and_updating_login_status( QString idpassed, QString passwordpassed, QString   &role )
{
...
void MainWindow::logging_out_updating_login_status_to_0( )
{
    QSqlQuery myquery;
    myquery.prepare("update seif.employee set LOGINSTATUS=0  where id_cin=:ID_CIN " );
...
void MainWindow::on_send_clicked()
{
    ...
    smtp = new Smtp(idmail , passwordmail, "smtp.gmail.com",465);
...
/*
void MainWindow::on_groupBox_chercher_clicked()
{
...
void MainWindow::on_radioButton_age_chercher_clicked()
{
...
void MainWindow::on_radioButton_score_chercher_clicked()
{
    //make sure to clear all
   // employ.reset_employee_attributes();
...
void MainWindow::on_radioButton_role_chercher_clicked()
{
    //make sure to clear all
   // employ.reset_employee_attributes();
...
void MainWindow::on_pushButton_clear_chercher_clicked()
{
    ui->dateEdit_age_chercher->hide();
...
void MainWindow::on_pushButton_go_chercher_clicked()
{
    //key if else
...
void MainWindow::on_radioButton_age_orderby_clicked()
{
...
void MainWindow::on_radioButton_score_orderby_clicked()
{
    //setting * where and caloumn of condition;
    employ.s.allstar="*";
    employ.s.orderby="order by";
...
void MainWindow::on_radioButton_credit_orderby_clicked()
{
    //setting * where and caloumn of condition;
    employ.s.allstar="*";
    employ.s.orderby="order by";
...
void MainWindow::on_pushButton_sortONLY_clicked()
{
    //key if else
...
void MainWindow::on_pushButton_searchANDsort_clicked()
{
...
void MainWindow::statistics_play()
{
...
void MainWindow::on_lineEdit_settingemail_textChanged(const QString &arg1)
{
    ui->lineEdit_company_email->setText(arg1);
    ui->lineEdit_company_email->setText(ui->lineEdit_settingemail->text());
}

void MainWindow::on_lineEdit_settingpassword_textChanged(const QString &arg1)
{
